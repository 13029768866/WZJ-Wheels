...
exports.default = _default;
  ...
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _vm.buttonIconName
    ? _c("svg", { staticClass: "icon" }, [
        _c("use", { attrs: { "xlink:href": "#icon-" + _vm.buttonIconName } })
      ])
    : _vm._e()
}
var staticRenderFns = []
...
var expect = _chai.default.expect; // icon单元测试

{
  ...
  button.$mount(div);
  var useElement = button.$el.querySelector('use'); // console.log(useElement);

  var href = useElement.getAttribute('xlink:href'); // 主观推断是否满足期待
...

{
  ...
  var _useElement = _button.$el.querySelector('use'); // console.log(useElement);


  var _href = _useElement.getAttribute('xlink:href'); // 是否满足期待
